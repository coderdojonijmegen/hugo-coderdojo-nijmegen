...
if(searchQuery){
  ...
  $('#search-results').append("<p>...voer eerst een zoekterm in...</p>");
}

function executeSearch(searchQuery){
  $.getJSON( "/instructies/index.json", function( data ) {
    var pages = data;
    ...
    if(result.length > 0){
      ...
      $('#search-results').append("<p>de zoekterm is niet gevonden</p>");
    }
  });
}
